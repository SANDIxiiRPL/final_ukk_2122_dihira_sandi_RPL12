...
<head>
    ...
    <title>peduli diri ukk2022</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">peduli diri ukk2022<sup></sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <h3>Aplikasi peduli diri - RPL SMKN 1 Singkarak</h3>
                    ...
                    <div class="h5 mb-4 text-gray-800">
                        <?php 
                            if(!empty(@$_GET['url'])){
                                ...
                                echo "welcome anda sekarang berada di dalam aplikasi catatan peduli diri. ";
