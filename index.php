...
<head>
    ...
    <title>selamat datang di peduli diri - Login</title>
            ...
            <div class="col-xl-6 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="row">
                        <div class="col-lg-12">
                            <br/>
                            <h1 class="h3 text-gray-900 text-center">Selamat datang di aplikasi peduli diri</h1>
                                <br/>
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-4"></div>
                                    <div class="col-4">
                                        <img src="img/rpl.jpg" alt="Responsive image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
